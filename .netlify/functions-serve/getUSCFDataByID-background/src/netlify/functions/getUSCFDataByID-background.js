...
// netlify/functions/getUSCFDataByID-background.ts
var getUSCFDataByID_background_exports = {};
__export(getUSCFDataByID_background_exports, {
  handler: () => handler
});
...
var handler = async (event, context) => {
  ...
  var result = await fetch("http://www.uschess.org/msa/thin.php?" + userID).then((data) => {
    var body = data;
    return {
      statusCode: 200,
      body: data
...
module.exports = __toCommonJS(getUSCFDataByID_background_exports);
...
//# sourceMappingURL=getUSCFDataByID-background.js.map
